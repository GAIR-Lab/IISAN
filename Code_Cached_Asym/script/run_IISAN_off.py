...
behaviors = 'am_Office_Products_users_10K.tsv'
images = 'Office_Products_items.tsv'
news = 'Office_Products_items.tsv'
lmdb_data = 'am_op.lmdb'
logging_num = 4
testing_num = 1
...
stored_vector_path = "../stored_vectors_off/"
