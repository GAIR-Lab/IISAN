...
stored_vector_path = "../stored_vectors_sci/"
cached_image_model = "eva_clip_18b_outputs"
...
# "1,7,13,19,25,31" -> for llama-7b and 8b vit huge
# "2,7,12,17,22,27" -> for gemma-7b
# "4,19,34,49,64,79" -> for llama-70b
# "5,15,25,35,45,55"
# "3,12,21,30,39,48" -> for eva-18B
# 
side_adapter_bert_list_ls = ["4,19,34,49,64,79"]
side_adapter_cv_list_ls = ["2,11,20,29,38,47"]
...
side_adapter_mm_list = "2,11,20,29,38,47"
...
image_layers = 48
image_embedding_dim = 5120
cached_text_prefix = "llama"#llama gemma mistral

for cv_adapter_down_size in cv_adapter_down_size_list:
    bert_adapter_down_size = cv_adapter_down_size
