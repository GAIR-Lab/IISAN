...
images = 'MicroLens-100k_title_en.tsv'
news = 'MicroLens-100k_title_en.tsv'
lmdb_data = 'am_microlens.lmdb'
logging_num = 4
testing_num = 1
...
stored_vector_path = "../stored_vectors_micro/"
cached_image_model = "vit_outputs"
cached_text_model = "bert_outputs" #llama70b_GPTQ_embeddings llama2_embeddings llama2_embeddings llama_it_embeddings mistral_7b_embeddings mistral_8x7B_it_embeddings
mode = 'train'
item_tower = 'modal'
...
bert_adapter_size_list = [64]

cv_adapter_down_size = 512
#bert_adapter_down_size = 512
# None or True
...
# "5,15,25,35,45,55"
# 
side_adapter_bert_list_ls = ["1,3,5,7,9,11"]
...
text_layers = 12 # 32 for mistral_7b 80 for llama_70b 56 layers
text_embedding_dim = 768 # 4096 for llama-7b 3072 for gemma-7b, 2048 for gemma-2b 8192 for llama-70b 4096 for mistral_7b_embeddings 6144 for mistral
cached_text_prefix = "bert"#llama gemma mistral
image_embedding_dim = 768 # 4096 for llama-7b 3072 for gemma-7b, 2048 for gemma-2b 8192 for llama-70b 4096 for mistral_7b_embeddings 6144 for mistral
cached_image_prefix = "vit"#llama gemma mistral


for bert_adapter_down_size in bert_adapter_size_list:
                                                      ...
                                                      for fine_tune_lr_image in fine_tune_lr_image_list:
                                                          for fine_tune_lr_text in fine_tune_lr_text_list:
                                                              ...
                                                              run_py = "CUDA_VISIBLE_DEVICES='0' \
                                                                       ...
                                                                       --finetune_layernorm {}  --cv_adapter_down_size {} --bert_adapter_down_size {} --adapter_bert_lr {} --bert_model_load {} --adapter_type {} --seed {} --side_adapter_vit_list {} --side_adapter_bert_list {} --side_adapter_mm_list {} --stored_vector_path {} --cached_image_model {} --cached_text_model {} --text_layers {} --text_embedding_dim {} --cached_text_prefix {} --cached_image_prefix {} --image_embedding_dim {}\
                                                                       ".format(
                                                                  ...
                                                                  CV_resize, CV_model_load, epoch, freeze_paras_before, fine_tune_lr_image,fine_tune_lr_text,pretrained_recsys_model,adapter_cv_lr,adding_adapter_to
                                                                               ,fine_tune_to,finetune_layernorm,cv_adapter_down_size,bert_adapter_down_size,adapter_bert_lr,bert_model_load,adapter_type,seed,side_adapter_cv_list,side_adapter_bert_list,side_adapter_mm_list,stored_vector_path,cached_image_model,cached_text_model,text_layers,text_embedding_dim,cached_text_prefix,cached_image_prefix,image_embedding_dim)
                                                              os.system(run_py)
