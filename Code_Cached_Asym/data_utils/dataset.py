...
class Build_MM_Dataset(Dataset):
    ...
    def __getitem__(self, user_id):
        ...
        for i in range(seq_Len):
            ...
            bert_output_loaded = load_output(self.stored_vector_path+self.cached_text_model, item_id, prefix=self.args.cached_text_prefix)


            sample_items_text.append(bert_output_loaded)            
            vit_output_loaded = load_output(self.stored_vector_path+self.cached_image_model, item_id, prefix=self.args.cached_image_prefix)
...
#         print("text final output size:",sample_items_text.shape)
#         print("image final output size:",sample_items_image.shape)
