...
def process_items(texts, images, bert_model, cv_model, tokenizer, batch_size=128):
    ...
    for batch_num in tqdm(range(num_batches)):
        ...
        # Release memory
        save_outputs('stored_vectors_sci/bert_outputs', bert_outputs, prefix='bert')
        save_outputs('stored_vectors_sci/vit_outputs', vit_outputs, prefix='vit')
...
def test():
    ...
    bert_output_loaded = load_output('stored_vectors_sci/bert_outputs', item_id_to_test, prefix='bert')
    vit_output_loaded = load_output('stored_vectors_sci/vit_outputs', item_id_to_test, prefix='vit')
