...
side_adapter_bert_list = "1,3,5,7,9,11"
                                            ...
                                            for fine_tune_lr_image in fine_tune_lr_image_list:
                                                for fine_tune_lr_text in fine_tune_lr_text_list:
                                                    ...
                                                    run_py = "CUDA_VISIBLE_DEVICES='0' \
                                                             python  -m torch.distributed.launch --nproc_per_node 1 --master_port 1235\
                                                             ...
                                                             --finetune_layernorm {}  --cv_adapter_down_size {} --bert_adapter_down_size {} --adapter_bert_lr {} --bert_model_load {} --adapter_type {} --seed {} --side_adapter_vit_list {} --side_adapter_bert_list {} --side_adapter_mm_list {} --stored_vector_path {}\
                                                             ".format(
                                                        ...
                                                        CV_resize, CV_model_load, epoch, freeze_paras_before, fine_tune_lr_image,fine_tune_lr_text,pretrained_recsys_model,adapter_cv_lr,adding_adapter_to
                                                                     ,fine_tune_to,finetune_layernorm,cv_adapter_down_size,bert_adapter_down_size,adapter_bert_lr,bert_model_load,adapter_type,seed,side_adapter_bert_list,side_adapter_bert_list,side_adapter_bert_list,stored_vector_path)
                                                    os.system(run_py)
