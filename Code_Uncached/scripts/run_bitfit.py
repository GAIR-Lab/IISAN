...
adapter_cv_lr_list = [4e-4] 
adapter_bert_lr_list = [4e-4]
adding_adapter_to_list = ['all']
#None or all
fine_tune_to_list = ['None']
# None or TRUE
finetune_layernorm = "None"
cv_adapter_down_size = 4
bert_adapter_down_size = 4
# None or True
                                    ...
                                    for fine_tune_lr_image in fine_tune_lr_image_list:
                                        for fine_tune_lr_text in fine_tune_lr_text_list:
                                            ...
                                            run_py = "CUDA_VISIBLE_DEVICES='0' \
                                                     ...
                                                     --finetune_layernorm {} --cv_adapter_down_size {} --bert_adapter_down_size {} --adapter_bert_lr {} --bert_model_load {} --adapter_type {} \
                                                     ".format(
                                                ...
                                                CV_resize, CV_model_load, epoch, freeze_paras_before, fine_tune_lr_image,fine_tune_lr_text,pretrained_recsys_model,adapter_cv_lr,adding_adapter_to
                                                             ,fine_tune_to,finetune_layernorm,cv_adapter_down_size,bert_adapter_down_size,adapter_bert_lr,bert_model_load,adapter_type)
                                            os.system(run_py)
